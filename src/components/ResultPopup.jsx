...
const ResultPopup = ({ show, isCorrect, onClose }) => {
  return (
    <AnimatePresence>
      {show && (
        /* Overlay flex: centra el modal perfectamente en cualquier pantalla */
        <motion.div
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
          exit={{ opacity: 0 }}
        ...
        >
          <motion.div
            ...
            className={`relative rounded-2xl shadow-2xl p-6 sm:p-8 w-full max-w-md ${isCorrect
          ...
          >
            ...
            <div className="text-center">
              ...
              <motion.h3
                ...
                className={`text-2xl sm:text-3xl font-bold mb-2 ${isCorrect
              ...
              <motion.p
                ...
                className={`text-base sm:text-lg ${isCorrect
                    ? 'text-green-700 dark:text-green-300'
                    : 'text-red-700 dark:text-red-300'
                  }`}
              >
              ...
              <motion.div
                ...
                className={`mt-4 text-xs ${isCorrect
